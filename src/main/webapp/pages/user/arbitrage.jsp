    ...
    <div id="content">
        ...
        <table>
            ...
            <%
                ...
                List<TradeChain> chains = new TradeChainManager().findAllChains(bestRates);
                ...
                List<TradeChain> bestArbitrages = arbitrageManager.selectBestArbitrages(arbitrages);
                ChainPrinter chainPrinter = new ChainPrinter();
                for (TradeChain chain : bestArbitrages) {
