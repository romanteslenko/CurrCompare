...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <table>
            ...
            <%
                List<Rate> specificRates = ratesManager.selectSpecificRates(
                        request.getParameter("start-currency"),
                        request.getParameter("target-currency"),
                        rates);
                specificRates.sort(new Comparator<Rate>() {
                    @Override
                ...
                for (Rate rate : specificRates) {
                    out.println(printer.printRateInTableRow(rate));
                }
            %>
